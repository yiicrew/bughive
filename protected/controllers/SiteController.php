...
class SiteController extends Controller
{
    ...
    public function accessRules()
    {
        return [
            [
                'allow',
                'actions' => ['login', 'logout', 'error', 'permission'],
                'users' => ['*'],
            ],
            [
                'allow',
    ...
    public function actionIndex()
    {
        ...
        if (empty($_GET)) {
            $this->redirect(['info/index', 'type' => 'bug', 'product_id' => Yii::app()->user->getState('product')]);
        } else {
            ...
            if (isset($_GET['r'])) {
                ...
                if (('info/edit' == $_GET['r']) && (isset($_GET['type'])) && (isset($_GET['id']))) {
                    $this->redirect(Yii::app()->createUrl('info/edit', ['type' => $_GET['type'], 'id' => $_GET['id']]));
                ...
                {
                    $this->redirect(Yii::app()->createUrl('info/index', ['type' => $_GET['type'], 'product_id' => $_GET['product_id']]));
                }
            }
        }
    }
    ...
    public function actionPermission()
    {
        ...
        $this->render('permission', ['permissionTable' => $permissionTable]);
    }
}
